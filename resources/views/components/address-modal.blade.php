    ...
    <div class="modal-dialog modal-dialog-centered">
        <form class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="mb-3">
                        <x-input-label class="form-label form-label-sm" for="name">{{ __('Name Of Address') }}</x-input-label>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-10">
                            <x-select-dropdown name="province"
                                options="Eastern Cape, Free State, Gauteng, Kwa-Zulu Natal, Limpopo, Mpumalanga, Northern Cape, North West, Western Cape" 
                                class="form-control form-control-sm border-success-subtle" required/>
