            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.permissions.update', ['permission' => $permission->id]) }}" method="POST">
                        ...
                        @endsession
                        <div class="row">
                            <x-input-label for="name">{{ __('Permission Name') }}</x-input-label>
                            <div class="input-group">
                                <x-input-text name="name" class=" form-control form-control-sm border-success-subtle" value="{{ $permission->name }}" />
