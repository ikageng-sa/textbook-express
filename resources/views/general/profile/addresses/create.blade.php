    ...
    <div class="row justify-content-center">
        <div class="col-sm-12 col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('general.profile.addresses.store') }}" method="post">
                        @csrf
                        @session('status')
                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <x-input-text name="name" class="form-control form-control-sm border-success-subtle" />
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-10">
                                    <select class="form-select border-success-subtle" name="province_id" required>
